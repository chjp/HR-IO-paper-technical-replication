...
library(pheatmap)
pdf("/data/lab/projects/TCRseq/output/published/Fig5d.v01.pdf")
pheatmap(clusters[,c(2,3,4,5)], scale = "column",
         cluster_rows = T, cluster_cols = T,
         show_rownames = T
)
dev.off()
pdf("/data/lab/projects/TCRseq/output/published/Fig5d.v02.pdf")
...
pdf("/data/lab/projects/TCRseq/output/published/scatter.v00.pdf")
